        ...
        <footer className="footer">
            <div className="container">
                <a className="logo" href="javascript:void(0);">
                    <img src="src/assets/images/logo-bookshelf.jpg" alt="Logo Plant" />
                </a>
                ...
                <div className="footer-block footer-categories">
                    <div className="footer-head">
                        Категории
                    </div>
                    <nav className="footer-items">
                ...
                <div className="footer-block footer-info">
                    ...
                    <div className="footer-payment">
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/1.png')"}}>&nbsp;</div>
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/2.png')"}}>&nbsp;</div>
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/3.png')"}}>&nbsp;</div>
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/4.png')"}}>&nbsp;</div>
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/5.png')"}}>&nbsp;</div>
                        <div className="payment-item" style={{"backgroundImage": "url('src/assets/images/payment/6.png')"}}>&nbsp;</div>
                    </div>
                </div>
                <div className="footer-block footer-contacts">
                    ...
                    <div className="footer-contact">
                        ...
                        <div className="footer-contact-info">
                            г. Тюмень, ул. Республки 61, подъезд 1, офис 2
                        </div>
                    </div>
                    <div className="footer-contact">
                        <div className="footer-contact-head">
